        ...
        <div className="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
          ...
          <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6" key={product.id}>
                    ...
                    <div className="flex items-center">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          setQuantities(prev => ({
                            ...prev,
                            [product.id]: newQuantity > 0 ? newQuantity : 1
                          }));
                        }}
                        min="1"
                        required
